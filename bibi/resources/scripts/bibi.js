  ...
  47: function (e, t, n) {
    ...
    var _ = {
      ...
      resetStage: function () {
        ...
        (_.Stage = {}),
          (_.Columned = !1),
          (_.Main.style.padding =
            _.Main.style.width =
            _.Main.style.height =
              ""),
          (_.Main.Book.style.padding =
            _.Main.Book.style.width =
            _.Main.Book.style.height =
              "");
        var n =
                ...
                if (!_.DoNotTurn && F["allow-placeholders"]) {
                  ...
                  t.Timer_Turn = setTimeout(function () {
                    return k
                      ...
                      .then(function () {
                        n.Up
                          ? (e.TurningItems_FaceUp =
                              e.TurningItems_FaceUp.filter(function (e) {
                                return e != t;
                              }))
                          : (e.TurningItems_FaceDown =
                              e.TurningItems_FaceDown.filter(function (e) {
                                return e != t;
                              })),
                          _.layOutItem(t)
                            .then(function () {
